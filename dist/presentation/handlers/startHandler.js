...
exports.userServiceState = exports.callbackHandler = exports.backToMenu = exports.textMessageHandler = exports.startHandler = exports.setServiceState = exports.getServiceState = void 0;
const telegraf_1 = require("telegraf");
// Store user's selected service state
const userServiceState = new Map();
exports.userServiceState = userServiceState;
const getServiceState = (userId) => {
    return userServiceState.get(userId) || null;
};
exports.getServiceState = getServiceState;
const setServiceState = (userId, service) => {
...
const textMessageHandler = async (ctx) => {
    ...
    switch (text) {
        case '🖼️ Add Logo to Photos':
            ...
            await ctx.reply('🖼️ *Add Logo Service Activated!*\n\n' +
                ...
                '_Send your photos now!_ 📤', { parse_mode: 'Markdown' });
            break;
        case '🎵 TikTok Sound to Video':
            // Set service state
            userServiceState.set(userId, 'tiktok');
            await ctx.reply('🎵 *TikTok Sound Service Activated!*\n\n' +
                ...
                '_Send your video now!_ 🎬', { parse_mode: 'Markdown' });
            break;
        case '⚙️ Settings':
            ...
            await ctx.reply('⚙️ *Settings*\n\n' +
                ...
                '*General:*\n' +
                '• /start — Main menu\n' +
                '• /help — Help guide', { parse_mode: 'Markdown' });
            break;
        case '❓ Help':
...
const callbackHandler = async (ctx) => {
    ...
    switch (callbackData) {
        case 'choose_logo':
            ...
            await ctx.reply('🖼️ *Add Logo Service*\n\nSend me your photos now!', { parse_mode: 'Markdown' });
            break;
        case 'choose_tiktok':
            userServiceState.set(userId, 'tiktok');
            await ctx.answerCbQuery('🎵 TikTok Sound service activated!');
            await ctx.reply('🎵 *TikTok Sound Service*\n\nSend me a video to get started!', { parse_mode: 'Markdown' });
            break;
        case 'back_to_menu':
            await ctx.answerCbQuery('Returning to main menu');
            await (0, exports.backToMenu)(ctx);
            break;
        default:
