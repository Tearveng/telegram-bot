...
const TikTokDownloadService_1 = require("./src/infrastructure/persistence/TikTokDownloadService");
const config_1 = require("./src/config/config");
const path_1 = require("path");
const TMP_DIR = (0, path_1.join)(process.cwd(), "tmp");
async function testBothUrls() {
    const service = new TikTokDownloadService_1.TikTokDownloadService(config_1.config, TMP_DIR);
...
testBothUrls();
//# sourceMappingURL=test-tiktok-download.js.map